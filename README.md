...
Certifique-se de ter o [Node.js](https://nodejs.org/)
    ...
    git clone git@github.com:mozgbrasil/heroku-react-app.git
    cd heroku-react-app
    npm install
    npm start
...
[![Deploy to Heroku](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/mozgbrasil/heroku-react-app)
...
```
npm init react-app heroku-react-app
npm start
```
...
https://github.com/supnate/rekit-boilerplate-cra#dist

```
rekit create heroku-react-app
```

```
cd ~/dados/git/projects/heroku-react-app
npm run start-rekit
```
...
```
cp -r ~/dados/git/projects/heroku-react-app/src/features/examples ~/dados/git/projects/heroku-react-app/src/features/murphy

cp -r ~/dados/git/projects/heroku-react-app/tests/features/examples ~/dados/git/projects/heroku-react-app/tests/features/murphy

# Search

grep -ri 'examples' ~/dados/git/projects/heroku-react-app/src/features/murphy
grep -ri 'examples' ~/dados/git/projects/heroku-react-app/src/features/murphy

grep -ri 'EXAMPLES' ~/dados/git/projects/heroku-react-app/tests/features/murphy
grep -ri 'EXAMPLES' ~/dados/git/projects/heroku-react-app/tests/features/murphy

# Feature

grep -rl 'Examples' ~/dados/git/projects/heroku-react-app/src/features/murphy | xargs sed -i "s/Examples/Murphy/g";
grep -rl 'examples' ~/dados/git/projects/heroku-react-app/src/features/murphy | xargs sed -i "s/examples/murphy/g";
grep -rl 'EXAMPLES' ~/dados/git/projects/heroku-react-app/src/features/murphy | xargs sed -i "s/EXAMPLES/MURPHY/g";

grep -rl 'Examples' ~/dados/git/projects/heroku-react-app/tests/features/murphy | xargs sed -i "s/Examples/Murphy/g";
grep -rl 'examples' ~/dados/git/projects/heroku-react-app/tests/features/murphy | xargs sed -i "s/examples/murphy/g";
grep -rl 'EXAMPLES' ~/dados/git/projects/heroku-react-app/tests/features/murphy | xargs sed -i "s/EXAMPLES/MURPHY/g";
...
grep -rl 'reddit' ~/dados/git/projects/heroku-react-app/src/features/murphy | xargs sed -i "s/reddit/intelipost/g";
grep -rl 'Reddit' ~/dados/git/projects/heroku-react-app/src/features/murphy | xargs sed -i "s/Reddit/Intelipost/g";
grep -rl 'REDDIT' ~/dados/git/projects/heroku-react-app/src/features/murphy | xargs sed -i "s/REDDIT/INTELIPOST/g";

grep -rl 'reddit' ~/dados/git/projects/heroku-react-app/tests/features/murphy | xargs sed -i "s/reddit/intelipost/g";
grep -rl 'Reddit' ~/dados/git/projects/heroku-react-app/tests/features/murphy | xargs sed -i "s/Reddit/Intelipost/g";
grep -rl 'REDDIT' ~/dados/git/projects/heroku-react-app/tests/features/murphy | xargs sed -i "s/REDDIT/INTELIPOST/g";

grep -ri 'reddit' ~/dados/git/projects/heroku-react-app/src/features/murphy

# Search Directory | File

find ~/dados/git/projects/heroku-react-app/src/features/murphy -type d -name "*reddit*" -print0 | while read -r -d '' file; do
  echo "$file"
done

find ~/dados/git/projects/heroku-react-app/src/features/murphy -type f -name "*Reddit*" -print0 | while read -r -d '' file; do
  echo "$file"
done
...
mv ~/dados/git/projects/heroku-react-app/src/features/murphy/RedditListPage.less ~/dados/git/projects/heroku-react-app/src/features/murphy/IntelipostListPage.less
mv ~/dados/git/projects/heroku-react-app/src/features/murphy/redux/fetchRedditList.js ~/dados/git/projects/heroku-react-app/src/features/murphy/redux/fetchIntelipostList.js
mv ~/dados/git/projects/heroku-react-app/src/features/murphy/RedditListPage.js ~/dados/git/projects/heroku-react-app/src/features/murphy/IntelipostListPage.js


find ~/dados/git/projects/heroku-react-app/tests/features/murphy -type d -name "*reddit*" -print0 | while read -r -d '' file; do
  echo "$file"
done

find ~/dados/git/projects/heroku-react-app/tests/features/murphy -type f -name "*Reddit*" -print0 | while read -r -d '' file; do
  echo "$file"
done
...
mv ~/dados/git/projects/heroku-react-app/tests/features/murphy/RedditListPage.test.js ~/dados/git/projects/heroku-react-app/tests/features/murphy/IntelipostListPage.test.js
mv ~/dados/git/projects/heroku-react-app/tests/features/murphy/redux/fetchRedditList.test.js ~/dados/git/projects/heroku-react-app/tests/features/murphy/redux/fetchIntelipostList.test.js
